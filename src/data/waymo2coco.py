"""
https://github.com/shinya7y/WaymoCOCO/blob/master/convert_waymo_to_coco.py
"""
...
def main():
    ...
    waymo_converter = WaymoCOCOConverter(image_dir)
    waymo_converter.process_sequences(tfrecord_list)
    waymo_converter.write_coco(label_path)
