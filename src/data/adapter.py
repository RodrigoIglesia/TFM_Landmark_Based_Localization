"""
Script to convert waymo datasettfrecords format to YOLO training dataset structure
This script was developed by Yao-Shao -> https://github.com/Yao-Shao/Waymo_Kitti_Adapter/tree/master
"""
...
DATA_PATH = src_dir + '/dataset/waymo_samples'
# path to save kitti dataset
KITTI_PATH = src_dir + '/dataset/waymo_train_format'
