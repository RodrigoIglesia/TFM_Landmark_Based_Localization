...
_MAPFEATURE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sign', full_name='waymo.open_dataset.MapFeature.sign', index=8,
...
_SIGN = _descriptor.Descriptor(
  name='Sign',
  full_name='waymo.open_dataset.Sign',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='position', full_name='waymo.open_dataset.Sign.position', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MAPFEATURE.fields_by_name['sign'].message_type = _SIGN
...
_MAPFEATURE.oneofs_by_name['feature_data'].fields.append(
  _MAPFEATURE.fields_by_name['sign'])
_MAPFEATURE.fields_by_name['sign'].containing_oneof = _MAPFEATURE.oneofs_by_name['feature_data']
...
_SIGN.fields_by_name['position'].message_type = _MAPPOINT
...
Sign = _reflection.GeneratedProtocolMessageType('Sign', (_message.Message,), dict(
  DESCRIPTOR = _SIGN,
  __module__ = 'map_signs_pb2'
  # @@protoc_insertion_point(class_scope:waymo.open_dataset.Sign)
  ))
