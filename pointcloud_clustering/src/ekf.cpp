...
int main (int argc, char** argv)
{
  ...
  ros::Publisher pub_ekfIncOdomRPY = nh.advertise<pointcloud_clustering::positionRPY>("ekfIncOdomRPY", 1); // debugging
  ros::Publisher pub_ekfPosition = nh.advertise<pointcloud_clustering::positionRPY>("ekfPosition", 1); // debugging
...
//       0, 0, 0, 0, 0, 1; // yaw  ------> Binding matrix: we store the components of elements in which we're interested (optional)
  ...
  // TODO: Esta parte vendría directamnte del msg Waymo
    // Habría que comentarlo y usar directamente las poses, sin considerar velocidad
    // Primero lo hago con las poses si inyectar ruido Gaussiano
